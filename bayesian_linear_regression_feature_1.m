%Bayesian Linear Regression ( with feature selection model 1)
...
Anew_1=Anew+((sig/var_prior)*eye(10202-features));   % best found deviation value of 0.0480 at lambda = 200
...
path=[directory '\bay_linear_reg_feat1.mat'];
save(path);